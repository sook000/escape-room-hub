...
public class GlobalExceptionHandler {
    ...
    private String traceId() {
        return org.slf4j.MDC.get("traceId"); // 필터에서 넣어둔 값
    }
    ...
    public ResponseEntity<ErrorResponse> handleMethodArgumentNotValid(
        ...
        ErrorResponse body = ErrorResponse.ofBindingResult(
                ErrorCode.INVALID_INPUT_VALUE, e.getBindingResult(), traceId(), serviceId, path(request));
    ...
    public ResponseEntity<ErrorResponse> handleTypeMismatch(MethodArgumentTypeMismatchException e,
        ...
        ErrorResponse body = ErrorResponse.ofTypeMismatch(
                ErrorCode.INVALID_INPUT_VALUE, e, traceId(), serviceId, path(request));
        return ResponseEntity.status(ErrorCode.INVALID_INPUT_VALUE.getStatus()).body(body);
    }
    ...
    public ResponseEntity<ErrorResponse> handleMethodNotAllowed(HttpRequestMethodNotSupportedException e,
        ...
        ErrorResponse body = ErrorResponse.of(ErrorCode.METHOD_NOT_ALLOWED, traceId(), serviceId, path(request));
...
//    }
    ...
    public ResponseEntity<ErrorResponse> handleEntityNotFound(EntityNotFoundException e, HttpServletRequest request) {
        ...
        ErrorResponse body = ErrorResponse.of(ErrorCode.RESOURCE_NOT_FOUND, traceId(), serviceId, path(request));
