package cs.escaperoomhub.article.api;
...
public class ArticleApiTest {
    ...
    @Test
    void readTest() {
        ArticleResponse response = read(193613355025625091L);
        System.out.println("response = " + response);
    }
    ...
    void deleteTest() {
        restClient.delete()
                .uri("/v1/articles/{articleId}", 193613355025625091L)
                .retrieve()
                .toBodilessEntity();
    }
