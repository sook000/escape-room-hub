package cs.escaperoomhub.hotarticle.api;

import cs.escaperoomhub.hotarticle.service.response.HotArticleResponse;
...
public class HotArticleApiTest {
    ...
    void readAllTest() {
        List<HotArticleResponse> responses = restClient.get()
                .uri("/v1/hot-articles/articles/date/{dateStr}", "20250926")
                .retrieve()
